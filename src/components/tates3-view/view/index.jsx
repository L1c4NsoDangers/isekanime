...
import TateS3 from "../../../../public/images/anime/TNYNT.jpg";
...
export default function TateS3View() {
  return (
      ...
      <div className="px-12 mt-12 py-12 flex flex-col gap-6 md:flex-row ">
        <div className="w-full md:w-1/2">
          <h1 className="border-l-4 border-orange-600 py-4 px-4 text-white uppercase text-2xl font-bold ">
            ...
            <span className="text-orange-600 ">Season 3</span>
          </h1>
          <div className="grid grid-cols-1 md:grid-cols-1 gap-6  py-8">
            <div className="text-white font-semibold">
              <p className="py-4">
                After defeating the Spirit Tortoise, Naofumi has no time for
                rest. An attack from the next Guardian Beast is imminent, but
                the three other Cardinal Heroes have gone missing. So, Naofumi
                and his party set out to search for the legendary trio.
              </p>
            </div>
            <InformationAnime
              type="TV"
              episode="12"
              status="On Going"
              reales="October 6, 2023, to ?"
              weather="Fall 2023"
              produser="Frontier Works, AT-X, Nippon Columbia, NTT Docomo, Glovision, Good Smile Company, Sammy, Crunchyroll, Kadokawa"
              lisensi="Unknown"
        ...
        <div className="w-full md:w-1/2 justify-center items-center py-4 px-4 text-center">
          <div className="grid grid-cols-1 md:grid-cols-1 gap-6 py-8">
            <div className="flex-col lg:w-full lg:flex items-center justify-between rounded-r-xl bg-orange-600 shadow-2xl">
              ...
              >
                <Image src={TateS3} alt="TateS3" className="w-full h-auto" />
              </Link>
              <div className="p-4 items-center text-center justify-center">
                <Link href="/tates3">
                  <h2 className="my-6 text-black text-2xl font-bold text-center uppercase hover:text-white">
                    TATE NO YUUSHA NO NARIAGI Season 3
                  </h2>
                </Link>
              </div>
            </div>
